 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(N,R){var _=N.length;N.push(R);e:for(;0<_;){var I=_-1>>>1,A=N[I];if(0<o(A,R))N[I]=R,N[_]=A,_=I;else break e}}function n(N){return N.length===0?null:N[0]}function r(N){if(N.length===0)return null;var R=N[0],_=N.pop();if(_!==R){N[0]=_;e:for(var I=0,A=N.length,oe=A>>>1;I<oe;){var ke=2*(I+1)-1,Tl=N[ke],Bt=ke+1,Lr=N[Bt];if(0>o(Tl,_))Bt<A&&0>o(Lr,Tl)?(N[I]=Lr,N[Bt]=_,I=Bt):(N[I]=Tl,N[ke]=_,I=ke);else if(Bt<A&&0>o(Lr,_))N[I]=Lr,N[Bt]=_,I=Bt;else break e}}return R}function o(N,R){var _=N.sortIndex-R.sortIndex;return _!==0?_:N.id-R.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;e.unstable_now=function(){return l.now()}}else{var i=Date,u=i.now();e.unstable_now=function(){return i.now()-u}}var s=[],c=[],d=1,m=null,h=3,v=!1,w=!1,y=!1,T=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,a=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(N){for(var R=n(c);R!==null;){if(R.callback===null)r(c);else if(R.startTime<=N)r(c),R.sortIndex=R.expirationTime,t(s,R);else break;R=n(c)}}function g(N){if(y=!1,p(N),!w)if(n(s)!==null)w=!0,St(E);else{var R=n(c);R!==null&&rn(g,R.startTime-N)}}function E(N,R){w=!1,y&&(y=!1,f(z),z=-1),v=!0;var _=h;try{for(p(R),m=n(s);m!==null&&(!(m.expirationTime>R)||N&&!X());){var I=m.callback;if(typeof I=="function"){m.callback=null,h=m.priorityLevel;var A=I(m.expirationTime<=R);R=e.unstable_now(),typeof A=="function"?m.callback=A:m===n(s)&&r(s),p(R)}else r(s);m=n(s)}if(m!==null)var oe=!0;else{var ke=n(c);ke!==null&&rn(g,ke.startTime-R),oe=!1}return oe}finally{m=null,h=_,v=!1}}var C=!1,x=null,z=-1,W=5,$=-1;function X(){return!(e.unstable_now()-$<W)}function Te(){if(x!==null){var N=e.unstable_now();$=N;var R=!0;try{R=x(!0,N)}finally{R?Qe():(C=!1,x=null)}}else C=!1}var Qe;if(typeof a=="function")Qe=function(){a(Te)};else if(typeof MessageChannel<"u"){var wt=new MessageChannel,Dn=wt.port2;wt.port1.onmessage=Te,Qe=function(){Dn.postMessage(null)}}else Qe=function(){T(Te,0)};function St(N){x=N,C||(C=!0,Qe())}function rn(N,R){z=T(function(){N(e.unstable_now())},R)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(N){N.callback=null},e.unstable_continueExecution=function(){w||v||(w=!0,St(E))},e.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):W=0<N?Math.floor(1e3/N):5},e.unstable_getCurrentPriorityLevel=function(){return h},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(N){switch(h){case 1:case 2:case 3:var R=3;break;default:R=h}var _=h;h=R;try{return N()}finally{h=_}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(N,R){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var _=h;h=N;try{return R()}finally{h=_}},e.unstable_scheduleCallback=function(N,R,_){var I=e.unstable_now();switch(typeof _=="object"&&_!==null?(_=_.delay,_=typeof _=="number"&&0<_?I+_:I):_=I,N){case 1:var A=-1;break;case 2:A=250;break;case 5:A=1073741823;break;case 4:A=1e4;break;default:A=5e3}return A=_+A,N={id:d++,callback:R,priorityLevel:N,startTime:_,expirationTime:A,sortIndex:-1},_>I?(N.sortIndex=_,t(c,N),n(s)===null&&N===n(c)&&(y?(f(z),z=-1):y=!0,rn(g,_-I))):(N.sortIndex=A,t(s,N),w||v||(w=!0,St(E))),N},e.unstable_shouldYield=X,e.unstable_wrapCallback=function(N){var R=h;return function(){var _=h;h=R;try{return N.apply(this,arguments)}finally{h=_}}}})(Ua);Aa.exports=Ua;var Ad=Aa.exports;/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var is=Symbol.for("react.element"),us=Symbol.for("react.portal"),gl=Symbol.for("react.fragment"),wl=Symbol.for("react.strict_mode"),Sl=Symbol.for("react.profiler"),xl=Symbol.for("react.provider"),kl=Symbol.for("react.context"),Zm=Symbol.for("react.server_context"),El=Symbol.for("react.forward_ref"),Cl=Symbol.for("react.suspense"),_l=Symbol.for("react.suspense_list"),Nl=Symbol.for("react.memo"),Pl=Symbol.for("react.lazy"),Jm=Symbol.for("react.offscreen"),cd;cd=Symbol.for("react.module.reference");function He(e){if(typeof e=="object"&&e!==null){var t=e.$$typeof;switch(t){case is:switch(e=e.type,e){case gl:case Sl:case wl:case Cl:case _l:return e;default:switch(e=e&&e.$$typeof,e){case Zm:case kl:case El:case Pl:case Nl:case xl:return e;default:return t}}case us:return t}}}B.ContextConsumer=kl;B.ContextProvider=xl;B.Element=is;B.ForwardRef=El;B.Fragment=gl;B.Lazy=Pl;B.Memo=Nl;B.Portal=us;B.Profiler=Sl;B.StrictMode=wl;B.Suspense=Cl;B.SuspenseList=_l;B.isAsyncMode=function(){return!1};B.isConcurrentMode=function(){return!1};B.isContextConsumer=function(e){return He(e)===kl};B.isContextProvider=function(e){return He(e)===xl};B.isElement=function(e){return typeof e=="object"&&e!==null&&e.$$typeof===is};B.isForwardRef=function(e){return He(e)===El};B.isFragment=function(e){return He(e)===gl};B.isLazy=function(e){return He(e)===Pl};B.isMemo=function(e){return He(e)===Nl};B.isPortal=function(e){return He(e)===us};B.isProfiler=function(e){return He(e)===Sl};B.isStrictMode=function(e){return He(e)===wl};B.isSuspense=function(e){return He(e)===Cl};B.isSuspenseList=function(e){return He(e)===_l};B.isValidElementType=function(e){return typeof e=="string"||typeof e=="function"||e===gl||e===Sl||e===wl||e===Cl||e===_l||e===Jm||typeof e=="object"&&e!==null&&(e.$$typeof===Pl||e.$$typeof===Nl||e.$$typeof===xl||e.$$typeof===kl||e.$$typeof===El||e.$$typeof===cd||e.getModuleId!==void 0)};B.typeOf=He;ad.exports=B;var qm=ad.exports;k`
  from,
  20%,
  53%,
  to {
...
`;function T1(e,t,n){switch(n){case"bottom-left":return t?v1:e1;case"bottom-right":return t?g1:t1;case"down":return e?t?S1:r1:t?w1:n1;case"left":return e?t?k1:o1:t?x1:ss;case"right":return e?t?C1:i1:t?E1:l1;case"top-left":return t?_1:u1;case"top-right":return t?N1:s1;case"up":return e?t?z1:c1:t?P1:a1;default:return t?y1:bm}}const eo=e=>{const{big:t=!1,direction:n,reverse:r=!1,...o}=e,l=L.useMemo(()=>T1(t,r,n),[t,n,r]);return le(dd,{keyframes:l,...o})};k`
  from {
...
`);var I1=L.memo(L.forwardRef(function(e,t){var n=e.sequence,r=e.repeat,o=e.className,l=e.speed,i=l===void 0?40:l,u=e.deletionSpeed,s=e.omitDeletionAnimation,c=s!==void 0&&s,d=e.preRenderFirstString,m=d!==void 0&&d,h=e.wrapper,v=h===void 0?"span":h,w=e.splitter,y=w===void 0?function(_){return lt([],Ze(_),!1)}:w,T=e.cursor,f=T===void 0||T,a=e.style,p=function(_,I){var A={};for(var oe in _)Object.prototype.hasOwnProperty.call(_,oe)&&I.indexOf(oe)<0&&(A[oe]=_[oe]);if(_!=null&&typeof Object.getOwnPropertySymbols=="function"){var ke=0;for(oe=Object.getOwnPropertySymbols(_);ke<oe.length;ke++)I.indexOf(oe[ke])<0&&Object.prototype.propertyIsEnumerable.call(_,oe[ke])&&(A[oe[ke]]=_[oe[ke]])}return A}(e,["sequence","repeat","className","speed","deletionSpeed","omitDeletionAnimation","preRenderFirstString","wrapper","splitter","cursor","style"]),g=p["aria-label"],E=p["aria-hidden"],C=p.role;u||(u=i);var x=new Array(2).fill(40);[i,u].forEach(function(_,I){switch(typeof _){case"number":x[I]=Math.abs(_-100);break;case"object":var A=_.type,oe=_.value;if(typeof oe!="number")break;A==="keyStrokeDelayInMs"&&(x[I]=oe)}});var z,W,$,X,Te,Qe,wt=x[0],Dn=x[1],St=function(_,I){I===void 0&&(I=null);var A=L.useRef(I);return L.useEffect(function(){_&&(typeof _=="function"?_(A.current):_.current=A.current)},[_]),A}(t),rn=M1;z=o?"".concat(f?rn+" ":"").concat(o):f?rn:"",W=L.useRef(function(){var _,I=n;r===1/0?_=Pa:typeof r=="number"&&(I=Array(1+r).fill(n).flat());var A=_?lt(lt([],Ze(I),!1),[_],!1):lt([],Ze(I),!1);return Pa.apply(void 0,lt([St.current,y,wt,Dn,c],Ze(A),!1)),function(){St.current}}),$=L.useRef(),X=L.useRef(!1),Te=L.useRef(!1),Qe=Ze(L.useState(0),2)[1],X.current&&(Te.current=!0),L.useEffect(function(){return X.current||($.current=W.current(),X.current=!0),Qe(function(_){return _+1}),function(){Te.current&&$.current&&$.current()}},[]);var N=v,R=m?n.find(function(_){return typeof _=="string"})||"":null;return vo.createElement(N,{"aria-hidden":E,"aria-label":g,role:C,style:a,className:z,children:g?vo.createElement("span",{"aria-hidden":"true",ref:St,children:R}):R,ref:g?void 0:St})}),function(e,t){return!0});/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const D1=e=>e.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase().trim(),hd=(e,t)=>{const n=L.forwardRef(({color:r="currentColor",size:o=24,strokeWidth:l=2,absoluteStrokeWidth:i,className:u="",children:s,...c},d)=>L.createElement("svg",{ref:d,...j1,width:o,height:o,stroke:r,strokeWidth:i?Number(l)*24/Number(o):l,className:["lucide",`lucide-${D1(e)}`,u].join(" "),...c},[...t.map(([m,h])=>L.createElement(m,h)),...Array.isArray(s)?s:[s]]));return n.displayName=`${e}`,n};/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const A1=hd("Sun",[["circle",{cx:"12",cy:"12",r:"4",key:"4exip2"}],["path",{d:"M12 2v2",key:"tus03m"}],["path",{d:"M12 20v2",key:"1lh1kg"}],["path",{d:"m4.93 4.93 1.41 1.41",key:"149t6j"}],["path",{d:"m17.66 17.66 1.41 1.41",key:"ptbguv"}],["path",{d:"M2 12h2",key:"1t8f8n"}],["path",{d:"M20 12h2",key:"1q8mjw"}],["path",{d:"m6.34 17.66-1.41 1.41",key:"1m8zz5"}],["path",{d:"m19.07 4.93-1.41 1.41",key:"1shlcs"}]]);function U1(){const[e,t]=L.useState(!0),n=()=>{t(!e)};return O.jsx("div",{className:"mx-auto px-5",children:O.jsxs("div",{className:`${e&&"dark"} min-h-screen`,children:[O.jsx(eo,{cascade:!0,damping:.2,triggerOnce:!0,children:O.jsxs("main",{className:"min-h-screen dark:bg-zinc-900 bg-slate-200 outline-none selection:bg-red-500 overflow-hidden",children:[O.jsx("div",{className:"h-48",children:O.jsxs(eo,{direction:"down",children:[O.jsx("h1",{className:"absolute left-6 top-6 font-normal celular:text-1xl lg:text-3xl font-Inter text-zinc-900 dark:text-slate-200",children:O.jsxs("a",{children:["PORTI",O.jsx("a",{className:" celular:text-lg lg:text-4xl font-Pixel text-blue-600  dark:text-indigo-500",children:"FOLIO"})]})}),O.jsx("div",{className:" absolute hidden lg:right-6 lg:top-6 ",children:O.jsxs("div",{className:"flex flex-row gap-6 font-normal font-JetBrains",children:[O.jsx("h1",{className:" text-4xl dark:text-slate-200",children:O.jsx("a",{children:"SOBRE"})}),O.jsx("h1",{className:" text-4xl dark:text-slate-200",children:O.jsx("a",{children:"PROJETOS"})}),O.jsx("h1",{className:" text-4xl dark:text-slate-200",children:O.jsx("a",{children:"CONTATO"})})]})})]})}),O.jsxs("div",{children:[O.jsx(eo,{direction:"down",children:O.jsx("h2",{className:" absolute animate-wiggle left-1/4 font-Pixel font-light lg:top-0 lg:text-3xl text-blue-400 dark:text-indigo-600 ",children:"I am..."})}),O.jsxs(eo,{direction:"up",children:[O.jsxs("h1",{className:" celular:relative celular:text-center celular:text-sm lg:left-72 font-JetBrains lg:text-left celular:m-8 celular:top-8 font-bold lg:top-16 lg:text-3xl dark:text-slate-200",children:[O.jsx(I1,{sequence:["Desginer",1e3,"Web Developer",1e3,"Music Producer",1e3,"Bruno B. Mathias",1e3],wrapper:"span",speed:50,style:{fontSize:"2em",display:"inline-block"},repeat:1/0}),O.jsx("blockquote",{className:"dark:text-slate-200 text-3xl lg:text-left mt-14",children:O.jsx("span",{className:" bg-zinc-800 p-3 rounded-2xl",children:'""'})})]}),O.jsxs("span",{className:" celular:relative grid grid-cols-3 p-0 celular:text-center celular:text-sm lg:left-72 font-JetBrains celular:m-8 celular:top-8 font-bold lg:top-16 lg:text-3xl dark:text-slate-200",children:[O.jsx("a",{className:"  ",children:"+"}),O.jsx("span",{children:"+"}),O.jsx("span",{children:"+"}),O.jsx("span",{children:"+"}),O.jsx("span",{children:"+"}),O.jsx("span",{children:"+"}),O.jsx("span",{children:"+"}),O.jsx("span",{children:"+"}),O.jsx("span",{children:"+"})]})]})]}),O.jsx("div",{className:"dark:bg-zinc-900 bg-slate-300"}),O.jsx("div",{className:"bg-slate-200"})]})}),O.jsx("button",{onClick:n,className:"absolute w-16 h-16 right-16 bottom-16 p-4 rounded-full font-medium font-Danci dark:bg-slate-200 bg-zinc-900 text-slate-200 dark:text-zinc-950",children:e?O.jsx(A1,{className:"absolute w-8 h-8 left-4 top-4"}):O.jsx(F1,{className:"absolute w-8 h-8 left-4 top-4"})})]})})}oi.createRoot(document.getElementById("root")).render(O.jsx(vo.StrictMode,{children:O.jsx(U1,{})}));
