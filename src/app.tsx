...
export function App() {
  ...
  return(
    <div className={`${darkMode && "dark"}`}>
      ...
      <main className="min-h-screen dark:bg-zinc-900 bg-slate-200 outline-none selection:bg-red-500 ">
        <div className="h-36">
        <Fade direction="down">
          
          <h1 className="absolute left-6 top-6 font-normal sm:text-4xl lg:text-3xl font-Inter text-zinc-900 dark:text-slate-200"><a>PORTI<a className=" text-4xl font-Pixel text-blue-600  dark:text-indigo-500">FOLIO</a></a></h1>
          ...
          <Fade direction="down">
            <h2 className=" absolute animate-wiggle left-1/4 font-Pixel font-light top-32 text-3xl text-blue-400 dark:text-indigo-600 ">I am...</h2>
          </Fade>
          
          <Fade direction="up">
            <h1 className=" absolute left-72 font-JetBrains font-bold top-48 text-4xl dark:text-slate-200"><TypeAnimation
                      sequence={[
